...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER ||
            ...
            Intent intentParking = new Intent(this, LoginActivity2.class);
            intentParking.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
     ...
     * If the user clicks the notification, control goes to the ParkingActivity.
     */
